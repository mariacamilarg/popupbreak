...
public class PanelAgenda extends JPanel {
    ...
    public PanelAgenda(InterfacePopUpBreak interfacePopUpBreak) {
        ...
        jLabel.setBackground(new Color(200, 221, 242));
        add(jLabel);
